    ...
    <div class="col-sm-7">
        <div class="product-information"><!--/product-information-->
            ...
            <div class="product-share" style="margin-top: 20px;">
                <p><b>Chia sẻ sản phẩm:</b></p>
                <a href="https://www.facebook.com/sharer/sharer.php?u={{ urlencode(Request::fullUrl()) }}" 
                   target="_blank" 
                   onclick="return shareOnFacebook(this.href)"
                   class="btn btn-primary share-facebook">
...
<!-- JavaScript để mở popup chia sẻ -->
<script>
                    ...
                    <div class="product-image-wrapper">
                        <div class="single-products">
                            <div class="productinfo text-center">
                                ...
                                <a href="#" class="btn btn-default add-to-cart-ajax">
